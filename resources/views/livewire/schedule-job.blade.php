        ...
        <div class="w-full">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex mt-4">
                    <div class="w-full px-4 py-2 text-base text-black transition duration-500 ease-in-out transform bg-gray-100 border-transparent rounded-lg focus:border-gray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2">
                        <div class="flex">
                          <select wire:model="endHours" class="bg-transparent appearance-none outline-none mr-3 text-center">
                            <option value="" disabled selected>Hour</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                          ...
                          <span class="mr-3">:</span>
                          <select wire:model="endMinutes" class="bg-transparent appearance-none outline-none mr-4">
                            <option value="" disabled selected>Minute</option>
                            <option value="00">00</option>
                            <option value="15">15</option>
                            <option value="30">30</option>
                          ...
                          <select wire:model="endAmpm" class="bg-transparent appearance-none outline-none">
                            <option value="" disabled selected>AM/PM</option>
                            <option value="am">AM</option>
                            <option value="pm">PM</option>
                          </select>
